...
app.post('/api/data', async (req, res) => {
    const { cityid, checkin, checkout, adults } = req.body; // Leer los parámetros enviados por el cliente

    const url = 'https://api.makcorps.com/city';
    const params = {
        cityid: cityid || '1064230', // Valor predeterminado si no se proporciona
        pagination: '0',
        cur: 'EUR',
        rooms: '1',
        adults: adults || '2', // Valor predeterminado
